...
\subsubsection*{Refrigeration Chambers Sources}

Panettone 4.0 is using temperature and humidity digital sensors in each of its two chambers where yeasts are fermented. These sensors are connected to the net of the factory and are sending the measured values to the Cool Analyst DIA with a 1 second sample frequency. This is why Cool Analyst requires two socket sources connected to the port and to the host of each of the chambers.

In order to simulate the behavior of a 

\subsubsection*{Refrigeration Chambers Transformations}

\subsubsection*{Refrigeration Chambers Sinks}
